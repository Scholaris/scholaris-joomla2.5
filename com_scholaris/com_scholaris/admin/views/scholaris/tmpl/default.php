...
<h2>Zasoby Scholaris</h2>
	
<li id="nav_search">
	<a onclick="$('#nav_user').removeClass('active');$('#nav_search').addClass('active');" href="http://creator.staging.scht.pl/external/publishlist/email/<?php echo $login; ?>" target="scholaristarget">Wyszukiwarka zasobów portalu</a>
</li>
<li id="nav_user">
